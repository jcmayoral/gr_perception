...
class DetectionRecorder:
    def __init__(self, folder="measured_example" ):
        ...
        self.folder = "safety_labels_"+folder
    ...
    def pose_cb(self,msg):
        ...
        #TOO FAR
        if min_distance > (self.n_classes-1)*self.distance:
            safety_zone = self.n_classes-1

        if  safety_zone != self.current_zone and safety_zone != -1:
            print (safety_zone)
