...
def extend_model(model, n_classes=4,activation = "relu", multiplier=2):
    ...
    model02 = create_convolution_sequence(model01,10*multiplier, kernel_size=(3,3), scale_pool=(2,2), pooling=True, padding='same', activation=activation)
    ...
    model12 = create_convolution_sequence(model11,10*multiplier, kernel_size=(3,3), scale_pool=(2,2), pooling=True, padding='same', activation=activation)
    ...
    model22 = create_convolution_sequence(model21,10*multiplier, kernel_size=(3,3), scale_pool=(2,2), pooling=True, padding='same', activation=activation)
    ...
    model32 = create_convolution_sequence(model31,10*multiplier, kernel_size=(3,3), scale_pool=(2,2), pooling=True, padding='same', activation=activation)
    ...
    concatenated = create_convolution_sequence(concatenated,4*multiplier, kernel_size=(3,3), activation=activation, pooling=True)
