...
val_steps_per_epoch = int(len(val_data_loader.rgb_images_list) / batch_size)
...
history = model.fit_generator(data_loader.generator(batch_size, ".jpeg"), steps_per_epoch= steps_per_epoch, epochs=n_epochs,
                                validation_data=val_data_loader.generator(batch_size, ".jpeg"), validation_steps=val_steps_per_epoch)
