...
def plot():
    ...
    ax.plot(trajectories_x, trajectories_y,c=cmap[trajectory_id], label="trajectory_"+str(trajectory_id), alpha=0.75)
...
if __name__ == '__main__':
    ...
    plt.title("Persons Trajectories on Odometry Frame")
    box = ax.get_position()
